...
inline u32 fillbit(u32 n) {
    return n == 0 ? 0 : (1ULL << (32 - clz(n))) - 1ULL;
}
...
## 数据结构: bitset
也叫位图, 相当于超长二进制整数, 状压中有用. 除了std::bitset外还可以手写bitset, 好处是可以实现范围填充, 以进行时间上的优化(详见[P5539 【XR-3】Unknown Mother-Goose](https://www.luogu.com.cn/problem/P5539)).
